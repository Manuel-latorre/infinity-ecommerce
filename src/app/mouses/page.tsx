...
import mousesBanner from '../../components/assets/mouses.svg'
...
export default function Mouses (){
   ...
   const mouses = products.filter(cat => cat.category === 'Mouses')
  ...
  const filteredByBrand = mouses.filter((product) => {
  ...
  //FILTER BY COLOR
    ...
    return(
        <div>
            <Image src={mousesBanner} style={{width:'100%'}} alt="teclados"/>
