...
import tecladosBanner from '../../components/assets/teclados1.svg'
...
export default function Teclados (){
  ...
  //FILTER BY COLOR
    ...
    return(
        <div>
          <Image src={tecladosBanner} style={{width:'100%'}} alt="teclados"/>
              ...
              <div style={{display:'flex', flexDirection:'column', alignItems:'center'}}>
                    ...
                    <div style={{marginTop:30}}>
                        ...
                        <CheckboxGroup>
                            ...
                            <Checkbox
                            value="celeste"
                            checked={selectedColors.includes("celeste")}
                            onChange={() => handleColorChange("celeste")} >
                                Celeste
                            </Checkbox>
