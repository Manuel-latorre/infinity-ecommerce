...
import playstation from '../../components/assets/ps.svg'
...
export default function Sony (){
   ...
   const sony = products.filter(cat => cat.brand === 'Sony')
  ...
  const filteredByBrand = sony.filter((product) => {
  ...
  //FILTER BY COLOR
    ...
    return(
        <div>
           <Image src={playstation} style={{width:'100%'}} alt="teclados"/>
              ...
              <div style={{display:'flex', flexDirection:'column', alignItems:'center'}}>
                    <div style={{marginTop:30}}>
                        ...
                        <CheckboxGroup>
                            ...
                            color='secondary'
                            value="violeta"
                            checked={selectedColors.includes("violeta")}
                            onChange={() => handleColorChange("violeta")} >
                                Violeta
                            </Checkbox>
